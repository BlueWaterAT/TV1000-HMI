...
public class InteractiveJTable extends JPanel {
	...
	public InteractiveJTable() {
		...
		paramEditor.setRowHeight( rowHeight );
		...
		params.addActionListener( new ActionListener() {
			...
			public void actionPerformed( ActionEvent arg0 ) {
				Frame f = JOptionPane.getFrameForComponent( InteractiveJTable.this );
				paramEditor.setSize( f.getWidth(), f.getHeight() );
				paramEditor.setLocationRelativeTo( null );
