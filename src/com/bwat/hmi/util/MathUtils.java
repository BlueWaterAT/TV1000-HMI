...
public final class MathUtils {
     ...
     * If min <= value <= max, value is returned.
     */
    public static int clamp_i(int val, int min, int max) {
        return Math.min(max, Math.max(val, min));
    }
    ...
    /**
     * Checks if a number is inside an exclusive-inclusive range
     *
     * @param val Value to be checked
     * @param min Minimum value
     * @param max Maximum value
     * @return if val is in the range (min, max]
     */
    public static boolean inRange_ex_in(double val, double min, double max) {
        return min < val && val <= max;
    }
     ...
     * @return if val is in the range [min, max]
     */
    public static boolean inRange_in(double val, double min, double max) {
        return min <= val && val <= max;
    }

    /**
     * Checks if a number is inside an inclusive-exclusive range
     *
     * @param val Value to be checked
     * @param min Minimum value
     * @param max Maximum value
     * @return if val is in the range [min, max)
     */
    public static boolean inRange_in_ex(double val, double min, double max) {
        return min <= val && val < max;
    }
